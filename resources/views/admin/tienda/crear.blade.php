    ...
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; padding: 20px 0;">
        <div style="width: 90%; max-width: 850px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; gap: 16px; flex-wrap: wrap;">
                <h1 style="font-size: 2rem; font-weight: bold; margin: 0;">CREAR PRODUCTO</h1>
            ...
            <form action="{{ route('admin.tienda.guardar') }}" method="POST" style="background: #d0dbd9; padding: 25px; border-radius: 8px;">
                @csrf
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="ruta_imagen" value="{{ old('ruta_imagen') }}" required maxlength="255" placeholder="img/Moneda.png" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('ruta_imagen') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('ruta_imagen') ? '#fff5f5' : '#fff' }};">
                </div>
                ...
                <div style="margin-bottom: 18px; display: flex; flex-direction: column; gap: 10px; background: #eef4f3; padding: 12px 14px; border-radius: 6px;">
                    ...
                    <label style="display: flex; align-items: center; gap: 10px; font-weight: 600; color: #333; font-size: 13px;">
                        <input type="checkbox" name="visible_en_tienda" value="1" {{ old('visible_en_tienda', true) ? 'checked' : '' }} style="width: 18px; height: 18px;">
