    ...
    <div class="admin-page">
        ...
        <div class="admin-main">
            ...
            <aside class="admin-sidebar">
                <button class="admin-sidebar-item active">Dashboard</button>
                <button class="admin-sidebar-item">Usuarios</button>
                <button class="admin-sidebar-item">Misiones</button>
                <button class="admin-sidebar-item">Eventos</button>
                <button class="admin-sidebar-item">Pase de paseo</button>
                <button class="admin-sidebar-item">Lugares</button>
                <button class="admin-sidebar-item">Recompensas</button>
            </aside>
