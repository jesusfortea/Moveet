...
@section('content')
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; padding: 20px 0;">
        <div style="width: 90%; max-width: 800px;">
            ...
            <form action="{{ route('admin.usuarios.guardar') }}" method="POST" style="background: #d0dbd9; padding: 25px; border-radius: 8px;">
                @csrf
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required minlength="3" maxlength="255" placeholder="Mínimo 3 caracteres" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('name') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('name') ? '#fff5f5' : '#fff' }};">
                    @if ($errors->has('name'))
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required placeholder="ejemplo@correo.com" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('email') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('email') ? '#fff5f5' : '#fff' }};">
                    @if ($errors->has('email'))
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 15px;">
                    <div>
                        ...
                        <input type="text" name="dni" value="{{ old('dni') }}" required maxlength="9" placeholder="12345678A" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('dni') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('dni') ? '#fff5f5' : '#fff' }}; text-transform: uppercase;">
                        @if ($errors->has('dni'))
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" value="{{ old('telefono') }}" required maxlength="15" placeholder="+34 600000000" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('telefono') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('telefono') ? '#fff5f5' : '#fff' }};">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required minlength="3" maxlength="255" placeholder="usuario_123" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('username') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('username') ? '#fff5f5' : '#fff' }};">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 15px;">
                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 5px; color: #333; font-size: 13px;">Contraseña <span style="color: #c00;">*</span></label>
                        <input type="password" name="password" required minlength="8" placeholder="Min. 8 caracteres" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('password') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('password') ? '#fff5f5' : '#fff' }};">
                    ...
                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 5px; color: #333; font-size: 13px;">Confirmar contraseña <span style="color: #c00;">*</span></label>
                        <input type="password" name="password_confirmation" required minlength="8" placeholder="Repetir contraseña" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('password') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('password') ? '#fff5f5' : '#fff' }};">
                    </div>
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="date" name="nacimiento" value="{{ old('nacimiento') }}" required style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('nacimiento') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('nacimiento') ? '#fff5f5' : '#fff' }};">
