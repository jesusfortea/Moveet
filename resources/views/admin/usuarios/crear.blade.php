...
@section('content')
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; padding: 20px 0;">
        <div style="width: 90%; max-width: 800px;">
            ...
            <form action="{{ route('admin.usuarios.guardar') }}" method="POST" style="background: #d0dbd9; padding: 40px; border-radius: 8px;" novalidate>
                @csrf

                <div style="margin-bottom: 25px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #333;">Nombre de usuario</label>
                    <input type="text" name="name" value="{{ old('name') }}" required maxlength="255" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('name') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                    @if ($errors->has('name'))
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('email') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                    @if ($errors->has('email'))
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                    <div>
                        ...
                        <input type="text" name="dni" value="{{ old('dni') }}" required maxlength="20" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('dni') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                        @if ($errors->has('dni'))
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" value="{{ old('telefono') }}" required maxlength="20" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('telefono') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required maxlength="255" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('username') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                    <div>
                        ...
                        <input type="password" name="password" required minlength="6" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('password') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" required minlength="6" style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('password') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
                    </div>
                </div>

                <div style="margin-bottom: 30px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #333;">Fecha nacimiento</label>
                    <input type="date" name="nacimiento" value="{{ old('nacimiento') }}" required style="width: 100%; padding: 12px 14px; border: 2px solid {{ $errors->has('nacimiento') ? '#cc0000' : '#999' }}; border-radius: 4px; font-size: 14px; box-sizing: border-box;">
