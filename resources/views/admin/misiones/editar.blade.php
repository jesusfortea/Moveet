...
@section('content')
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; padding: 20px 0;">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="number" name="metros_requeridos" value="{{ old('metros_requeridos', $mision->metros_requeridos) }}" min="1" max="99999" placeholder="1000" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('metros_requeridos') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('metros_requeridos') ? '#fff5f5' : '#fff' }};">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 15px;">
            <div>
                ...
                <input type="number" name="ejeX" value="{{ old('ejeX', $mision->ejeX) }}" step="any" min="-180" max="180" placeholder="-3.7038" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('ejeX') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('ejeX') ? '#fff5f5' : '#fff' }};">
                @if ($errors->has('ejeX'))
            ...
            <div>
                ...
                <input type="number" name="ejeY" value="{{ old('ejeY', $mision->ejeY) }}" step="any" min="-90" max="90" placeholder="40.4168" style="width: 100%; padding: 10px 12px; border: 2px solid {{ $errors->has('ejeY') ? '#c00' : '#999' }}; border-radius: 4px; font-size: 13px; box-sizing: border-box; background: {{ $errors->has('ejeY') ? '#fff5f5' : '#fff' }};">
                @if ($errors->has('ejeY'))
